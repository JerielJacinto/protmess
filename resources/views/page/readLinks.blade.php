    ...
    <div class="container">
        ...
        @foreach($messageLinkDetails as $messageLinkDetail)
            <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div class="alert alert-success" style="font-size: 20px;" role="alert"> This message was already been viewed! </div>
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-2 mb-0">
                                   <a href="/"  class="btn btn-primary w-100">Create another encrypte message</a>
                                </div><!--end col-->
                            </div>
                        </form>                                    
                    </div>
