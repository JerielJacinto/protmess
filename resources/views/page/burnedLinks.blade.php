...
@section('page-title')
Burned Links - Protected Message
@endsection
    ...
    <div class="container">
        ...
        @foreach($messageLinkDetails as $messageLinkDetail)
            <div class="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div class="alert alert-warning" style="font-size: 20px;" role="alert"> This message was Burned! </div>

                <div class="section-title">
                    <h4 class="title mb-4">Send sensitive information<br> with Message <span class="text-primary">Protect.</span></h4>
