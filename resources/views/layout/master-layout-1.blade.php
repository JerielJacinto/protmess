...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>@yield('page-title') Share your sensitive message protected.</title>
    ...
    <body data-gr-c-s-loaded="true" style="overflow: visible;">
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0&appId=306705974102751&autoLogAppEvents=1" nonce="L8dAigYh"></script>
        <!-- Navbar STart -->
        ...
        @include('ajaxPart.terms-modal')
        @include('ajaxPart.privacy-modal')
